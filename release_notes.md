...
- **FTx features** (Shawn K7IHZ / LB2JK):
  ...
  + **FT4** support: all the same features as FT8, just twice as fast
  + Timestamp precision as necessary for FT4
  + FTX_CQ ALT_EVEN setting: CQ every 4th slot so you can listen more
  + FTX_AUTO modes:
    * OFF is fully manual
	* ANS auto-answers and finishes QSOs
